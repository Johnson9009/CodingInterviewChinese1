...
set(21_MIN_IN_STACK_SRCS ${21_MIN_IN_STACK_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/min_in_stack.cc
)
...
add_executable(21_min_in_stack ${21_MIN_IN_STACK_SRCS})
...
target_compile_features(21_min_in_stack PRIVATE cxx_std_11)
