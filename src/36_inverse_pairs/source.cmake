...
set(36_INVERSE_PAIRS_SRCS ${36_INVERSE_PAIRS_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/inverse_pairs.cc
)
...
add_executable(36_inverse_pairs ${36_INVERSE_PAIRS_SRCS})
...
target_compile_features(36_inverse_pairs PRIVATE cxx_std_11)
