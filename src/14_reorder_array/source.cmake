...
set(14_REORDER_ARRAY_SRCS ${14_REORDER_ARRAY_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/reorder_array.cc
)
...
add_executable(14_reorder_array ${14_REORDER_ARRAY_SRCS})
...
target_compile_features(14_reorder_array PRIVATE cxx_std_11)
