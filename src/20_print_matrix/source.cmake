...
set(20_PRINT_MATRIX_SRCS ${20_PRINT_MATRIX_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/print_matrix.cc
)
...
add_executable(20_print_matrix ${20_PRINT_MATRIX_SRCS})
...
target_compile_features(20_print_matrix PRIVATE cxx_std_11)
