...
set(39_02_BALANCED_BINARY_TREE_SRCS ${39_02_BALANCED_BINARY_TREE_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/balanced_binary_tree.cc
)
...
add_executable(39_02_balanced_binary_tree ${39_02_BALANCED_BINARY_TREE_SRCS})
...
target_compile_features(39_02_balanced_binary_tree PRIVATE cxx_std_11)
target_link_libraries(39_02_balanced_binary_tree basic_data_structure)
