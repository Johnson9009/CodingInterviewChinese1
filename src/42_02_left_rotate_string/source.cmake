...
set(42_02_LEFT_ROTATE_STRING_SRCS ${42_02_LEFT_ROTATE_STRING_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/left_rotate_string.cc
)
...
add_executable(42_02_left_rotate_string ${42_02_LEFT_ROTATE_STRING_SRCS})
...
target_compile_features(42_02_left_rotate_string PRIVATE cxx_std_11)
target_link_libraries(42_02_left_rotate_string basic_data_structure)
