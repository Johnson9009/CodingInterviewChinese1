...
set(04_REPLACE_SPACES_SRCS ${04_REPLACE_SPACES_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/replace_spaces.cc
)
...
add_executable(04_replace_spaces ${04_REPLACE_SPACES_SRCS})
...
target_compile_features(04_replace_spaces PRIVATE cxx_std_11)
