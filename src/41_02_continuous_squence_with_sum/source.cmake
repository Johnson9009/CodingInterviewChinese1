...
set(41_02_CONTINUOUS_SQUENCE_WITH_SUM_SRCS ${41_02_CONTINUOUS_SQUENCE_WITH_SUM_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/continuous_squence_with_sum.cc
)
...
add_executable(41_02_continuous_squence_with_sum ${41_02_CONTINUOUS_SQUENCE_WITH_SUM_SRCS})
...
target_compile_features(41_02_continuous_squence_with_sum PRIVATE cxx_std_11)
