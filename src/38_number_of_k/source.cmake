...
set(38_NUMBER_OF_K_SRCS ${38_NUMBER_OF_K_SRCS}
    ${CMAKE_CURRENT_LIST_DIR}/number_of_k.cc
)
...
add_executable(38_number_of_k ${38_NUMBER_OF_K_SRCS})
...
target_compile_features(38_number_of_k PRIVATE cxx_std_11)
